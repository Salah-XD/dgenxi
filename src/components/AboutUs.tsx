...
function AboutUs() {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-purple-600 via-purple-900 to-blue-800 text-white px-4 py-12 md:px-8 lg:px-16 overflow-hidden rounded-3xl">
  {/* Decorative Elements */}
